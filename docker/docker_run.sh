...
image_name=labelfusion:whizhou-v1
...
xhost +local:root;
docker run --runtime=nvidia -it -e DISPLAY -e QT_X11_NO_MITSHM=1 -v /tmp/.X11-unix:/tmp/.X11-unix:rw -v $source_dir:/root/labelfusion $data_mount_arg --privileged -v /dev/bus/usb:/dev/bus/usb $image_name
xhost -local:root;
